...
/******/ 	__webpack_require__.p = "//localhost:9000/beauty-cult-wordpress/wp-content/themes/beauty-cult";
/******/
/******/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony default export */ __webpack_exports__[\"default\"] = (__webpack_require__.p + \"css/dist/main.min.css\");\n\n//# sourceURL=webpack:///./css/src/app.scss?");
...
"use strict";
eval("\n\n// // typical import\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\n// // or get other plugins:\n// import Draggable from \"gsap/Draggable\";\n// import ScrollTrigger from \"gsap/ScrollTrigger\";\n\n// or all tools are exported from the \"all\" file (excluding bonus plugins):\n// import { gsap, ScrollTrigger, Draggable, MotionPathPlugin } from \"gsap/all\";\n\n// import './vendors/blotter.min.js';\n\n// console.log('gsap library', gsap);\n\nvar _gsap = __webpack_require__(/*! gsap */ \"./node_modules/gsap/index.js\");\n\nvar _gsap2 = _interopRequireDefault(_gsap);\n\n__webpack_require__(/*! ./scripts/accordion.js */ \"./js/src/scripts/accordion.js\");\n\n__webpack_require__(/*! ./scripts/page-transition.js */ \"./js/src/scripts/page-transition.js\");\n\n__webpack_require__(/*! ./scripts/image-transition.js */ \"./js/src/scripts/image-transition.js\");\n\n__webpack_require__(/*! ../../css/src/app.scss */ \"./css/src/app.scss\");\n\nvar _Teachers = __webpack_require__(/*! ./sections/Teachers */ \"./js/src/sections/Teachers.js\");\n\nvar _Teachers2 = _interopRequireDefault(_Teachers);\n\nvar _Atmo = __webpack_require__(/*! ./sections/Atmo */ \"./js/src/sections/Atmo.js\");\n\nvar _Atmo2 = _interopRequireDefault(_Atmo);\n\nvar _Review = __webpack_require__(/*! ./sections/Review */ \"./js/src/sections/Review.js\");\n\nvar _Review2 = _interopRequireDefault(_Review);\n\nvar _gsapCore = __webpack_require__(/*! gsap/gsap-core */ \"./node_modules/gsap/gsap-core.js\");\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar App = function () {\n    function App() {\n        _classCallCheck(this, App);\n\n        this.atmo = new _Atmo2.default(\".section.atmo\");\n        this.teachers = new _Teachers2.default(document.querySelector('.section.teachers'));\n        this.review = new _Review2.default(document.querySelector('.section.review'));\n    }\n\n    _createClass(App, [{\n        key: 'run',\n        value: function run() {\n            this.teachers.run();\n            this.atmo.run();\n            this.review.run();\n        }\n    }]);\n\n    return App;\n}();\n\nwindow.onload = function () {\n    var app = new App();\n\n    app.run();\n};\n\nvar mainPageNavmenu = function mainPageNavmenu() {\n    var menu = document.querySelector(\".header__menu\");\n    var btnOpen = document.querySelector(\"#btnMenuOpen\");\n    var btnClose = document.querySelector(\"#btnMenuClose\");\n\n    if (!menu) return;\n\n    btnOpen.addEventListener(\"click\", function () {\n        menu.classList.remove(\"visually-hidden\");\n    });\n\n    btnClose.addEventListener(\"click\", function () {\n        menu.classList.add(\"visually-hidden\");\n    });\n};\n\nmainPageNavmenu();\n\n// Open close Nav menus - course page\nvar coursePageNavMenu = function coursePageNavMenu() {\n    var navigation = document.querySelector(\".navigation\");\n    var navButton = document.querySelector(\".navigation-button\");\n    var btnArrow = document.querySelector(\".btn-arrow\");\n\n    if (!navigation) return;\n\n    navButton.addEventListener(\"click\", function () {\n        navigation.classList.toggle(\"visually-hidden\");\n        btnArrow.classList.toggle(\"active\");\n    });\n};\n\ncoursePageNavMenu();\n\n//# sourceURL=webpack:///./js/src/app.js?");
...
"use strict";
eval("\n\n// function hideAllExcept (itemIndex) {\n//     accordionItems.forEach((item, index) => {\n//         if (itemIndex === index) return\n\n//         const outerList = item.querySelector(\".accordion__outer-list\");\n//         const innerList = item.querySelector(\".accordion__inner-list\");\n//         const title = item.querySelector(\".item__title\");\n//         const btn = item.querySelector(\".btn-accordion\");\n\n//         outerList.classList.remove(\"active\")\n//         title.classList.remove(\"active\");\n//         innerList.classList.add(\"visually-hidden\");\n//         btn.classList.remove(\"active\");\n//     });\n// }\n\n// accordionItems.forEach( (item, index)  => {\n//     const outerList = item.querySelector('.accordion__outer-list');\n//     const innerList = item.querySelector(\".accordion__inner-list\");\n//     const title = item.querySelector(\".item__title\");\n//     const btn = item.querySelector(\".btn-accordion\");\n\n//     outerList.addEventListener('click', function() {\n//         hideAllExcept(index);\n\n//         title.classList.toggle('active');\n//         innerList.classList.toggle('visually-hidden');\n//         btn.classList.toggle('active');\n//     });\n\n// });\n\n\nvar accordionItems = Array.from(document.querySelectorAll(\".accordion .accordion-item\"));\ndocument.addEventListener(\"DOMContentLoaded\", function () {\n  var firstItem = accordionItems[0];\n  var outerList = firstItem.querySelector(\".accordion__outer-list\");\n  var innerList = firstItem.querySelector(\".accordion__inner-list\");\n  var title = firstItem.querySelector(\".item__title\");\n  var btn = firstItem.querySelector(\".btn-accordion\");\n\n  title.classList.toggle(\"active\");\n  innerList.classList.toggle(\"visually-hidden\");\n  btn.classList.toggle(\"active\");\n});\n\nvar headerAccordionItems = Array.from(document.querySelectorAll(\".header .header-accordion-item\"));\n\nvar accordionLogic = function accordionLogic(array) {\n  function hideAllExcept(itemIndex) {\n    array.forEach(function (item, index) {\n      if (itemIndex === index) return;\n\n      var outerList = item.querySelector(\".accordion__outer-list\");\n      var innerList = item.querySelector(\".accordion__inner-list\");\n      var title = item.querySelector(\".item__title\");\n      var btn = item.querySelector(\".btn-accordion\");\n\n      outerList.classList.remove(\"active\");\n      title.classList.remove(\"active\");\n      innerList.classList.add(\"visually-hidden\");\n      btn.classList.remove(\"active\");\n    });\n  }\n\n  array.forEach(function (item, index) {\n    var outerList = item.querySelector(\".accordion__outer-list\");\n    var innerList = item.querySelector(\".accordion__inner-list\");\n    var title = item.querySelector(\".item__title\");\n    var btn = item.querySelector(\".btn-accordion\");\n\n    outerList.addEventListener(\"click\", function () {\n      hideAllExcept(index);\n\n      title.classList.toggle(\"active\");\n      innerList.classList.toggle(\"visually-hidden\");\n      btn.classList.toggle(\"active\");\n    });\n  });\n};\n\naccordionLogic(headerAccordionItems);\naccordionLogic(accordionItems);\n\n//# sourceURL=webpack:///./js/src/scripts/accordion.js?");

/***/ }),

/***/ "./js/src/scripts/image-transition.js":
/*!********************************************!*\
  !*** ./js/src/scripts/image-transition.js ***!
  \********************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nvar _gsap = __webpack_require__(/*! gsap */ \"./node_modules/gsap/index.js\");\n\n// // or get other plugins:\n// import Draggable from \"gsap/Draggable\";\n// import ScrollTrigger from \"gsap/ScrollTrigger\";\n\n\nvar headerAnimation = function headerAnimation() {}; // // typical import\n// import gsap from \"gsap\";\n\n\nvar heroAnimation = function heroAnimation() {\n  var logo = document.querySelector(\".header-logo\");\n  var headerButton = document.querySelector(\".btn-header\");\n\n  var hero = document.querySelector(\".hero\");\n  var subtitle = hero.querySelector(\".hero__suptitle\");\n  var title = hero.querySelector(\".hero__title\");\n  var heroButton = hero.querySelector(\".btn-outline\");\n  var facebook = hero.querySelector(\".facebook\");\n  var instagram = hero.querySelector(\".instagram\");\n\n  var tl = _gsap.gsap.timeline();\n};\n\nvar courseCardAnimation = function courseCardAnimation() {\n  var image = document.querySelector(\".courses__card .course-image\");\n  var additionalImage = document.querySelector(\".courses__card .course-image-additional\");\n  var text = document.querySelector(\".courses__card .course-description\");\n  var bullets = document.querySelectorAll(\".courses__card .card__info-bullet\");\n  var tl = _gsap.gsap.timeline();\n\n  tl.from(image, { duration: 0.5, opacity: 0 });\n  tl.from(additionalImage, { duration: 0.5, opacity: 0, x: 250 }, \"-=0.4\");\n  tl.from(text, { duration: 0.3, opacity: 0, y: 50 }, \"-=0.3\");\n  tl.from(bullets, { stagger: 0.1, opacity: 0, y: 100 }, \"-=0.3\");\n};\n\nvar image = document.querySelector(\".courses__card .course-image\");\nif (image) {\n  var config = {\n    attributes: true,\n    attributeFilter: [\"src\"]\n  };\n\n  var animateImage = function animateImage(mutationsList, observer) {\n    var _iteratorNormalCompletion = true;\n    var _didIteratorError = false;\n    var _iteratorError = undefined;\n\n    try {\n      for (var _iterator = mutationsList[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {\n        var mutation = _step.value;\n\n        if (mutation.type === \"attributes\" && mutation.attributeName === \"src\") {\n          courseCardAnimation();\n          observer.takeRecords();\n        }\n      }\n    } catch (err) {\n      _didIteratorError = true;\n      _iteratorError = err;\n    } finally {\n      try {\n        if (!_iteratorNormalCompletion && _iterator.return) {\n          _iterator.return();\n        }\n      } finally {\n        if (_didIteratorError) {\n          throw _iteratorError;\n        }\n      }\n    }\n  };\n\n  var observer = new MutationObserver(animateImage);\n  observer.observe(image, config);\n}\n\n//# sourceURL=webpack:///./js/src/scripts/image-transition.js?");

/***/ }),

/***/ "./js/src/scripts/page-transition.js":
/*!*******************************************!*\
  !*** ./js/src/scripts/page-transition.js ***!
  \*******************************************/
/*! no static exports found */
...
"use strict";
eval("// import barba from \"@barba/core\";\n\n// function pageTransition() {\n//     var tl = gsap.timeline();\n\n//     // tl.to('')\n// }\n\n// function delay(n) {\n//     n = n || 2000;\n//     return new Promise(done => {\n//         setTimeout(() => {\n//             done();\n//         }, n );\n//     });\n// };\n\n// barba.init({\n//   sync: true,\n//   transitions: [{\n//       async leave(data) {\n//         const done = this.async();\n\n//         pageTransition();\n//         await delay(1500);\n//         done();\n//       }\n//   }]\n// });\n\n\n//# sourceURL=webpack:///./js/src/scripts/page-transition.js?");

/***/ }),

/***/ "./js/src/sections/Atmo.js":
/*!*********************************!*\
  !*** ./js/src/sections/Atmo.js ***!
  \*********************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _slider = __webpack_require__(/*! @components/slider.js */ \"./js/src/components/slider.js\");\n\nvar _slider2 = _interopRequireDefault(_slider);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar Atmo = function () {\n  function Atmo(htmlElement) {\n    _classCallCheck(this, Atmo);\n\n    this._root = htmlElement;\n    this._slider = null;\n    this._sliderElement = this._root + ' .swiper-container';\n\n    this._swiperSettings = {\n      breakpoints: {\n        1024: {\n          initialSlide: 0,\n          slidesPerView: 4,\n          loop: true,\n          spaceBetween: 16,\n          centeredSlides: false\n        }\n      },\n      navigation: {\n        clickable: true,\n        nextEl: this._root + ' .slider-nav-next',\n        prevEl: this._root + ' .slider-nav-prev'\n      },\n      flipEffect: {\n        rotate: 30,\n        slideShadows: true\n      }\n    };\n  }\n\n  /**\n   * @private\n   * @method _initSlider\n   * @return {Atmo}\n   */\n\n\n  _createClass(Atmo, [{\n    key: '_initSlider',\n    value: function _initSlider() {\n      this._slider = new _slider2.default(this._sliderElement, this._swiperSettings);\n      this._slider.run();\n\n      return this;\n    }\n\n    /**\n     * @public\n     * @method run\n     * @returns {void}\n     */\n\n  }, {\n    key: 'run',\n    value: function run() {\n      this._initSlider();\n    }\n  }]);\n\n  return Atmo;\n}();\n\nexports.default = Atmo;\n\n//# sourceURL=webpack:///./js/src/sections/Atmo.js?");

/***/ }),

/***/ "./js/src/sections/Review.js":
/*!***********************************!*\
  !*** ./js/src/sections/Review.js ***!
  \***********************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _slider = __webpack_require__(/*! @components/slider.js */ \"./js/src/components/slider.js\");\n\nvar _slider2 = _interopRequireDefault(_slider);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar Review = function () {\n    function Review(htmlElement) {\n        _classCallCheck(this, Review);\n\n        this._root = htmlElement;\n        this._slider = null;\n\n        this._swiperSettings = {\n            breakpoints: {\n                1024: {\n                    initialSlide: 0,\n                    slidesPerView: 3,\n                    spaceBetween: 16,\n                    centeredSlides: true\n                    //   slidesPerView: \"auto\",\n                }\n            }\n        };\n    }\n\n    /**\n     * @private\n     * @method _initSlider\n     * @return {Review}\n     */\n\n\n    _createClass(Review, [{\n        key: '_initSlider',\n        value: function _initSlider() {\n            this._slider = new _slider2.default(this._root, this._swiperSettings);\n            this._slider.run();\n\n            return this;\n        }\n\n        /**\n         * @public\n         * @method run\n         * @returns {void}\n         */\n\n    }, {\n        key: 'run',\n        value: function run() {\n            this._initSlider();\n        }\n    }]);\n\n    return Review;\n}();\n\nexports.default = Review;\n\n//# sourceURL=webpack:///./js/src/sections/Review.js?");

/***/ }),

/***/ "./js/src/sections/Teachers.js":
/*!*************************************!*\
  !*** ./js/src/sections/Teachers.js ***!
  \*************************************/
/*! no static exports found */
