...
<section class="hero">
    <div class="container">
        <h1 class="h3 hero__suptitle">Школа візуальної естетики</h1>
        <h3 class="h1 hero__title">Ми створюємо красу</h3>
        <a href="#sectionCourses"><button class="btn btn-outline">Хочу навчатися</button></a>
                ...
                <li class="item">
                    <a href="" class="social-link">
                        <svg width="14" height="26" viewBox="0 0 14 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M8.75777 26V14.1408H12.7386L13.3327 9.51828H8.75777V6.5713C8.75777 5.22852 9.12614 4.32541 11.0512 4.32541H13.4991V0.178245C13.0713 0.11883 11.6216 0 9.93419 0C6.40494 0 3.99269 2.15082 3.99269 6.10786V9.51828H0V14.1408H3.99269V26H8.75777Z" fill="#ffffff"/>
                        </svg>
                    </a>
                </li>
...
<section class="section promo">
    <div id="light"></div>
    <div class="container">
        <span class="promo-description" id="distortion-text">Голос краси лунає тихо...</span>

        <span class="promo-description--2">...він озивається тільки найбільш чутливим</span>
    </div>
</section>
