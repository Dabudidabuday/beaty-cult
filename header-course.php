    ...
    <div class="navigation-container">
        <div class="navigation-list">
            ...
            <?php foreach ($terms as $term) { 
                ...
                <div class="item">
                    <h3 class="h1 navigation-title"><?php echo $term->name ?></h3>
